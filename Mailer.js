...
export async function sendMailToUser(name, email) {
  ...
  try {
    ...
    console.log('Mali to user sent', response)
  } catch (error) {
    console.error('Mail to user send Failed: ', error)
  }
}
...
export async function sendMailToCompany(name, email, message) {
  ...
  try {
    ...
    console.log('Mali to murali sent', response)
  } catch (error) {
    console.error('Mail to murali send Failed: ', error)
  }
}
